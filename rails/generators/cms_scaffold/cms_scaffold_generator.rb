class CmsScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      m.template(
        'controllers/public/controller.rb', File.join('app/controllers', controller_class_path, "#{controller_file_name}_controller.rb")
      )
